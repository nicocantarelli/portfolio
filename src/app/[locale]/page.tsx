          ...
          <TableOfContents sections={sections}>
            <Link href="/lab" className={styles.tocLabLink}>
              <span className={styles.labWordWrap}>
                {t('navigation.lab')}
                <svg className={styles.labCircle} viewBox="0 0 100 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M85 6C91 8 96 13 97 18C98 23 95 29 88 33C81 37 68 39 55 38C42 37 27 33 17 28C7 23 2 17 2 13C2 9 7 5 15 4C23 3 37 4 48 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
              </span>
            </Link>
          </TableOfContents>
